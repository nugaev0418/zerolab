    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->logoFile) {
                ...
                // vaqt + random nom
                $fileName = 'brand_' . time() . '_' . uniqid() . '.' . $model->logoFile->extension;

                $model->logoFile->saveAs($uploadPath . $fileName);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            if ($model->logoFile) {
                ...
                $fileName = 'brand_' . $model->id . '_' . time() . '.' . $model->logoFile->extension;
                $model->logoFile->saveAs($uploadPath . $fileName);
